...
<head>
    <meta charset="UTF-8">
    <title>Product List - Non Grocery Products</title>
    ...
    <script type="text/javascript">
        ...
        function deleteItem(ItemToDelete) {
            ...
            $.ajax({
                url: "../EditProducts/EditOthersListFunctions.php",
                type: "post",
                data: {delete: "true", id: "O"+ItemToDelete.cells[0].innerHTML}
            });
...
<?php
include("../EditProducts/EditOthersListFunctions.php");
?>
...
<div class="container">
    <div class="jumbotron text-center title">
        <h1 class="h1"><span style="color: #ffed00">P</span>roducts List - Non Grocery Products</h1>
    </div>
</div>

<button type="button" class="btn btn-primary" onclick="window.location.href = '../EditProducts/EditOthers.php';">Add</button>
