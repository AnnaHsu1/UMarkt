...
function loadTable() {
    ...
    $items = $xmlDoc -> documentElement -> getElementsByTagName("seafood");
...
function addItem() {
    ...
    header("Location: ../ProductList/ProductListSeafood.php");
}

function addNewItem(&$xmlDoc) {

    $itemList = $xmlDoc -> getElementById("SeafoodList");

    $newItem = $xmlDoc -> createElement("seafood");
    $newItem -> setAttribute("id", "S".$_POST["seafoodId"]);

    $id = $xmlDoc -> createElement("id", $_POST["seafoodId"]);
...
function editExistingItem(&$xmlDoc) {
    ...
    $product = $xmlDoc -> getElementById("S".$_POST["seafoodId"]);
...
function checkID() {
    ...
    $products = $xmlDoc -> documentElement -> getElementsByTagName("seafood");
...
function idExists($id) {
    ...
    $item = $xmlDoc -> getElementById("S".$id);
