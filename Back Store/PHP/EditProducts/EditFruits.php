...
<?php
include("EditFruitsListFunctions.php");
?>
...
<div class="jumbotron text-center" style="background-color: #ffe8a1; padding: 2%;">
    ...
    <form method="post" action="EditFruitsListFunctions.php">

        <div class="form-group row">
            <label class="col-sm-2 col-form-label">Product ID</label>
            <div class="col-sm-10">
                <input type="text" id="product-id" name="fruitsId" class="form-control" value='<?php if(isset($_GET["id"])){echo $_GET["id"];} else {echo checkID();} ?>' placeholder="Product ID" readonly>
...
if(isset($_GET["id"])){
    ...
    $item = $xmlDoc -> getElementById("FRU".$_GET["id"]);
