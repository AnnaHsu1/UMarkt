...
function loadTable() {
    ...
    $items = $xmlDoc -> documentElement -> getElementsByTagName("fruits");
...
function addItem() {
    ...
    header("Location: ../ProductList/ProductListFruits.php");
}

function addNewItem(&$xmlDoc) {

    $itemList = $xmlDoc -> getElementById("FruitsList");

    $newItem = $xmlDoc -> createElement("fruits");
    $newItem -> setAttribute("id", "FRU".$_POST["fruitsId"]);

    $id = $xmlDoc -> createElement("id", $_POST["fruitsId"]);
...
function editExistingItem(&$xmlDoc) {
    ...
    $product = $xmlDoc -> getElementById("FRU".$_POST["fruitsId"]);
...
function checkID() {
    ...
    $products = $xmlDoc -> documentElement -> getElementsByTagName("fruits");
...
function idExists($id) {
    ...
    $item = $xmlDoc -> getElementById("FRU".$id);
