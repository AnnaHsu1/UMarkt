...
function loadTable() {
    ...
    $items = $xmlDoc -> documentElement -> getElementsByTagName("frozen");
...
function addItem() {
    ...
    header("Location: ../ProductList/ProductListFrozen.php");
}

function addNewItem(&$xmlDoc) {

    $itemList = $xmlDoc -> getElementById("FrozenList");

    $newItem = $xmlDoc -> createElement("frozen");
    $newItem -> setAttribute("id", "FRO".$_POST["frozenId"]);

    $id = $xmlDoc -> createElement("id", $_POST["frozenId"]);
...
function editExistingItem(&$xmlDoc) {
    ...
    $product = $xmlDoc -> getElementById("FRO".$_POST["frozenId"]);
...
function checkID() {
    ...
    $products = $xmlDoc -> documentElement -> getElementsByTagName("frozen");
...
function idExists($id) {
    ...
    $item = $xmlDoc -> getElementById("FRO".$id);
