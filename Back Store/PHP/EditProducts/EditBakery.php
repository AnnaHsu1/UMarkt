...
<?php
include("EditBakeryListFunctions.php");
?>
...
<div class="jumbotron text-center" style="background-color: #ffe8a1; padding: 2%;">
    ...
    <form method="post" action="EditBakeryListFunctions.php">

        <div class="form-group row">
            <label class="col-sm-2 col-form-label">Product ID</label>
            <div class="col-sm-10">
                <input type="text" id="product-id" name="bakeryId" class="form-control"
...
if (isset($_GET["id"])) {
    ...
    $item = $xmlDoc->getElementById("BA" . $_GET["id"]);
