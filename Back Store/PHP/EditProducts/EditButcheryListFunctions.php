...
function loadTable() {
    ...
    $items = $xmlDoc -> documentElement -> getElementsByTagName("butchery");
...
function addItem() {
    ...
    header("Location: ../ProductList/ProductListButchery.php");
}

function addNewItem(&$xmlDoc) {

    $itemList = $xmlDoc -> getElementById("ButcheryList");

    $newItem = $xmlDoc -> createElement("butchery");
    $newItem -> setAttribute("id", "BU".$_POST["butcheryId"]);

    $id = $xmlDoc -> createElement("id", $_POST["butcheryId"]);
...
function editExistingItem(&$xmlDoc) {
    ...
    $product = $xmlDoc -> getElementById("BU".$_POST["butcheryId"]);
...
function checkID() {
    ...
    $products = $xmlDoc -> documentElement -> getElementsByTagName("butchery");
...
function idExists($id) {
    ...
    $item = $xmlDoc -> getElementById("BU".$id);
