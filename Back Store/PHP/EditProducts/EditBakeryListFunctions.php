...
<?php
    ...
    function loadTable() {
        ...
        $items = $xmlDoc -> documentElement -> getElementsByTagName("bakery");
    ...
    function addItem() {
        ...
        header("Location: ../ProductList/ProductListBakery.php");
    }

    function addNewItem(&$xmlDoc) {

        $itemList = $xmlDoc -> getElementById("BakeryList");

        $newItem = $xmlDoc -> createElement("bakery");
        $newItem -> setAttribute("id", "BA".$_POST["bakeryId"]);

        $id = $xmlDoc -> createElement("id", $_POST["bakeryId"]);
    ...
    function editExistingItem(&$xmlDoc) {
        ...
        $product = $xmlDoc -> getElementById("BA".$_POST["bakeryId"]);
    ...
    function checkID() {
        ...
        $products = $xmlDoc -> documentElement -> getElementsByTagName("bakery");
